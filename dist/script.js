...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date("10-20-2020"));
});
...
var forms = function forms() {
  function makeServerData(form) {
    ...
    var data = {};
    formData.forEach(function (elem, key) {
      data[key] = elem;
    });
  ...
  function makeMessage(text) {
    ...
    return "<p style=\"color : ".concat(color, "\">").concat(text, "</p>");
  }
    ...
    return regeneratorRuntime.async(function sendData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return regeneratorRuntime.awrap(fetch("http://localhost:3020/orders", {
              method: "POST",
              headers: {
          ...
          case 5:
            return _context.abrupt("return", Promise.resolve("succssess"));
  ...
  forms.forEach(function (form) {
    form.addEventListener("submit", function (event) {
      event.preventDefault();
      var data = makeServerData(form);
      var message = document.createElement("p");
      message.innerHTML = makeMessage(messages.loading, "blue");
      form.append(message);
      sendData(data).then(function (res) {
        console.log(res);
...
var modals = function modals() {
  function makeModal(btnSelector, popupSelector, closeSelector) {
    ...
    var close = document.querySelector("".concat(popupSelector, " ").concat(closeSelector));
  ...
  makeModal(".popup_engineer_btn", ".popup_engineer", ".popup_close"); // 2 Задание из ТЗ
...
/* harmony default export */ __webpack_exports__["default"] = (jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
...
var tabs = function tabs() {
  ...
  function showCurrentTab(tabContent, tabI, links, activeClassName) {
  ...
  function makeTabs(tabsSelector, tabContentSelector, linkSelector, activeClassName, display) {
    ...
    tabs.forEach(function (tab, tabI) {
...
var timer = function timer() {
  var deadline = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  ...
  function getTime(deadline) {
    var time = (deadline - Date.now()) / 1000; // Сразу переводим в секунды

    if (time < 0) {
      console.log("Время вышло, введите новую дату");
    }

    var days = addZero(Math.floor(time / (60 * 60 * 24)));
    var hours = addZero(Math.floor(time / 60 / 60 % 24));
    var minutes = addZero(Math.floor(time / 60 % 60));
